  ...
  const sidebarContent = (
    <nav className="flex flex-col h-full">
      ...
      <div className="px-3 pb-3">
        <a
          href="https://github.com/ukk1019-yhat/visualai_edualttech"
          target="_blank"
          rel="noopener noreferrer"
          className={cn(
            'flex items-center gap-3 px-3 py-2 rounded-lg text-xs text-muted-foreground hover:text-foreground hover:bg-muted/50 transition-all',
